...
// Valida o trova youtubeId per ogni ricetta usando solo fetch e parsing HTML.
...
// Sostituisci con gli ID canali reali
...
function extractIdsFromSearch(html){
  // YouTube search contiene più occorrenze "videoId":"XXXXXXXXXXX"
...
async function validateId(id){
  // oEmbed per verificare esistenza
...
async function resolveForRecipe(r){
  ...
  // 1) Se la ricetta ha già un campo youtubeId o youtube url, prova quello
  ...
  // 2) Fallback semplice: cerca per titolo + "ricetta"
